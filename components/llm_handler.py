...
def render_sidebar():
    ...
    language_options = LanguageHandler.get_language_options()
    ...
    # Category cards
    categories = [
        ("🌾", "Agriculture & Farming", "PM-KISAN, Crop Insurance, Kisan Credit"),
        ("🏥", "Health & Welfare", "Ayushman Bharat, Health Insurance"),
        ("🏠", "Housing & Infrastructure", "PM Awas Yojana, Rural Housing"),
        ("💼", "Employment & Skills", "MGNREGA, Skill Development"),
        ("👨‍👩‍👧", "Social Welfare", "Pension, Women Empowerment"),
    ...
    <div class="sidebar-tip">
        ...
        <div class="sidebar-tip-text">
            Ask questions in your preferred language! You can type or use the 🎤 button to speak.
        </div>
    </div>
    """, unsafe_allow_html=True)
